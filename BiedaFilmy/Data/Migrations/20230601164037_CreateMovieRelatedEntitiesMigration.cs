...
{
    public partial class CreateMovieRelatedEntitiesMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Employments", x => new { x.MovieId, x.PersonId });
                    table.ForeignKey(
                        name: "FK_Employments_Movies_MovieId",
                        column: x => x.MovieId,
